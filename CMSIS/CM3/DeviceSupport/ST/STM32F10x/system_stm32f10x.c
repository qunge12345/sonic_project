...
#elif defined SYSCLK_FREQ_88MHz
  uint32_t SystemCoreClock         = SYSCLK_FREQ_88MHz;        /*!< System Clock Frequency (Core Clock) */
...
#elif defined SYSCLK_FREQ_112MHz
  uint32_t SystemCoreClock         = SYSCLK_FREQ_112MHz;        /*!< System Clock Frequency (Core Clock) */
...
#elif defined SYSCLK_FREQ_88MHz
  static void SetSysClockTo88(void);
#elif defined SYSCLK_FREQ_96MHz
  static void SetSysClockTo96(void);
#elif defined SYSCLK_FREQ_104MHz
  static void SetSysClockTo104(void);
#elif defined SYSCLK_FREQ_112MHz
  static void SetSysClockTo112(void);
#elif defined SYSCLK_FREQ_120MHz
...
#elif defined SYSCLK_FREQ_88MHz
/**
  * @brief  Sets System clock frequency to 88MHz and configure HCLK, PCLK2 
  *         and PCLK1 prescalers. 
  * @note   This function should be used only after reset.
  * @param  None
  * @retval None
...
static void SetSysClockTo88(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /* PLL configuration: PLLCLK = PREDIV1 * 11 = 88 MHz */ 
    RCC->CFGR &= (uint32_t)~(RCC_CFGR_PLLXTPRE | RCC_CFGR_PLLSRC | RCC_CFGR_PLLMULL);
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLXTPRE_PREDIV1 | RCC_CFGR_PLLSRC_PREDIV1 | 
                            RCC_CFGR_PLLMULL9); 
#else    
    /*  PLL configuration: PLLCLK = HSE * 11 = 88 MHz */
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL11);
#endif /* STM32F10X_CL */
...
#elif defined SYSCLK_FREQ_112MHz
/**
  * @brief  Sets System clock frequency to 112MHz and configure HCLK, PCLK2 
  *         and PCLK1 prescalers. 
  * @note   This function should be used only after reset.
  * @param  None
  * @retval None
...
static void SetSysClockTo112(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /* PLL configuration: PLLCLK = PREDIV1 * 14 = 112 MHz */ 
    RCC->CFGR &= (uint32_t)~(RCC_CFGR_PLLXTPRE | RCC_CFGR_PLLSRC | RCC_CFGR_PLLMULL);
    RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLXTPRE_PREDIV1 | RCC_CFGR_PLLSRC_PREDIV1 | 
                            RCC_CFGR_PLLMULL14); 
#else    
    /*  PLL configuration: PLLCLK = HSE * 14 = 112 MHz */
    RCC->CFGR &= (uint32_t)((uint32_t)~(RCC_CFGR_PLLSRC | RCC_CFGR_PLLXTPRE |
                                        RCC_CFGR_PLLMULL));
